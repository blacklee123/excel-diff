...
export class ExcelHelper {
  ...
  public static BlankData = (row: number, col: number):string[][] => {
    return new Array(row).fill("").map(() => new Array(col).fill(""));
  };

  public getSheet = (wb: WorkBook, sheetname: string):Promise<SheetDomain> => {
  ...
  public convertFileToExcel = (file: Blob): Promise<ExcelDomain> => {
